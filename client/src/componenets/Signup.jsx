...
export default function Signup() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if(json.success){
          ...
          console.log("E-mail exists","danger");
        }
    }
  return (
    <div id='login-page'>
      <div className="container">
        ...
        <div className="login__field">
            ...
            <div className="login__field">
                <i className="login__icon fas fa-lock"></i>
                <input type="password" className="login__input" placeholder='Confirm Password' id="cpassword" name='cpassword' onChange={onChange} value={cred.cpassword} required minLength={5}/>
            </div>
